...
variable "instance_type" {
  description = "EC2 instance type for the staging application tier."
  type        = string
}

variable "min_size" {
  description = "Minimum ASG size for staging."
  type        = number
}

variable "desired_capacity" {
  description = "Desired ASG capacity for staging."
  type        = number
}

variable "max_size" {
  description = "Maximum ASG size for staging."
  type        = number
}
